...
*/	
		...
		se (indice >= 0.3 e indice < 0.4) {
			escreva("Indústrias do 1º grupo devem suspender as suas atividades.")
		}
		senao se (indice >= 0.4 e indice < 0.5) {
			escreva("Indústrias do 1º e 2º grupo devem suspender as suas atividades.")
		}
		senao se (indice >= 0.5) {
			escreva("Indústrias do 1º, 2º e 3º grupo devem suspender as suas atividades.")
		}
		senao {
			escreva ("As atividades de todos os grupos industriais podem proceder normalmente.")
		}
	}
}
/* $$$ Portugol Studio $$$ 
